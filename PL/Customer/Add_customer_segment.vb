Imports BLL
Public Class Add_customer_segment

    Dim IdBill As Integer

    Private Sub btAdd_Click(sender As Object, e As EventArgs) Handles btAdd.Click
        Try
            If tbListData.Text <> String.Empty And txt_detail.Text <> String.Empty Then
                If MsgBox("ต้องการบันทึกข้อมูลใช่มั้ย ?", MsgBoxStyle.Question Or MsgBoxStyle.YesNo, "Confirm") = MsgBoxResult.Yes Then
                    ...
                    If BLL_Bill.InsertListBill(tbListData.Text, txt_detail.Text, "ประเภทลูกค้า") Then
                        MsgBox("บันทึกข้อมูลสำเร็จ", MsgBoxStyle.Information, "Information")
                        Clear()
                        Add_customer_segment_Load(sender, e)
                    Else
    ...
    Private Sub Add_customer_segment_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            btAdd.Enabled = True
            Dim BLL_Bill As BLL_BIll = New BLL_BIll
            Dim Dt As DataTable = BLL_Bill.SelectListBill("ประเภทลูกค้า")
            DGV.Rows.Clear()
        ...
        Try
            If tbListData.Text <> String.Empty And txt_detail.Text <> String.Empty Then
                If MsgBox("ต้องการแก้ไขข้อมูลใช่มั้ย ?", MsgBoxStyle.Question Or MsgBoxStyle.YesNo, "Confirm") = MsgBoxResult.Yes Then
                    Dim BLL_Bill As BLL_BIll = New BLL_BIll
                    If BLL_Bill.UpdateListBill(IdBill, tbListData.Text, txt_detail.Text) Then
